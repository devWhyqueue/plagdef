...
def _create_seeds(seed_tpls: list[tuple]):
    ...
    [doc1.sents.add(Sentence(idx, idx + 1, Counter(), doc1)) for idx in range(max_idx_doc1[0] + 1)]
    [doc2.sents.add(Sentence(idx, idx + 1, Counter(), doc2)) for idx in range(max_idx_doc2[1] + 1)]
    seeds = []
