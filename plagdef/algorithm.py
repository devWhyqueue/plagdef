...
def tf_idf(list_dic1, voc1, list_dic2, voc2):
    """
    DESCRIPTION: Compute the tf-idf <tf x log(N/df)>  from a list of sentences with tf and the vocabularies in
...
def tf_idf_hard(list_dic1, voc1, list_dic2, voc2):
    """
    DESCRIPTION: Compute the tf-idf <tf x [log(N/df)]^2>  from a list of sentences with tf and the vocabularies in
    suspicios and source document
    INPUT: list_dic1 <list of dictionaries> -  List containing the vectors (dictionaries) of document 1
           voc1 <dictionary> - Vocabulary at document 1 with the idf of each one
           list_dic2 <list of dictionaries> -  List containing the vectors (dictionaries) of document 2
...
def tf_idf_soft(list_dic1, voc1, list_dic2, voc2):
    """
    DESCRIPTION: Compute the tf-idf <tf x [log(N/df)]^0.5>  from a list of sentences with tf and the vocabularies in
    suspicios and source document
    INPUT: list_dic1 <list of dictionaries> -  List containing the vectors (dictionaries) of document 1
           voc1 <dictionary> - Vocabulary at document 1 with the idf of each one
           list_dic2 <list of dictionaries> -  List containing the vectors (dictionaries) of document 2
...
def tf_idf_ind(list_dic1, voc1, list_dic2, voc2):
    """
    DESCRIPTION: Compute the tf-idf <tf x log(N/df)>  from a list of sentences with tf and the vocabulary of each
    document separately
    INPUT: list_dic1 <list of dictionaries> -  List containing the vectors (dictionaries) of document 1
           voc1 <dictionary> - Vocabulary at document 1 with the idf of each one
           list_dic2 <list of dictionaries> -  List containing the vectors (dictionaries) of document 2
...
def longest_common_substring_all(s1, s1_off, s2, s2_off,
                                 th):  # Using Dynamic programming #Necesito encontrar todos los elementos mayor a un
    # umbral en lugar de solo el mayor
    """
...
def tokenize(text, voc={}, offsets=[], sents=[], rem_sw=0):
    ...
    OUTPUT: sent_vects <list of dictionaries> - List of dictionaries representing each sentence vector. Sparce bag of
...
class SGSPLAG:
    ...
    def compare(self):
        ...
        # if type_plag == 0:
        #     for plag in plags:
        #         arg1 = (self.susp_offsets[plag[0][0]][0], self.susp_offsets[plag[0][1]][0] + self.susp_offsets[
        #         plag[0][1]][1])
        #         arg2 = (self.src_offsets[plag[1][0]][0], self.src_offsets[plag[1][1]][0] + self.src_offsets[plag[
        #         1][1]][1])
